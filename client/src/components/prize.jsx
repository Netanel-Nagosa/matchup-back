        ...
        <div className="card-first3-blok">
          {rewards[0] && (
            <div className="card1" key={0} aria-label={rewards[0].name}>
              ...
              ></div>
              <a href="https://www.uefa.com/tickets/" target="_blank" rel="noreferrer">
            ...
            {[1, 2].map((index) => (
              rewards[index] && (
                <div className="cardMain2N3" key={index} aria-label={rewards[index].name}>
                  <div
                    className="card-blur-bg"
                    style={{ backgroundImage: `url(${rewards[index].image})` }}
                  ></div>
                  <a target="_blank" rel="noreferrer" href={index === 1 ? 'https://www.apple.com/il/iphone/' : 'https://www.lg.com/il/tv/lg-50ut80006la?utm_campaign=lastcallmay&utm_source=google&utm_medium=cpc&utm_content=oledtv_wave2&utm_content=oledtv&gad_source=1&gad_campaignid=22603346061&gbraid=0AAAAADhlMWfz7mHqxZRTuJwZHRyNN8nL8&gclid=Cj0KCQjw9O_BBhCUARIsAHQMjS5ksmcI6oewFpmU44XHdCfxhyn-TBFB7MeFDxSD37I9G8kAL0BMKH8aAggYEALw_wcB#pdp_where'}>
                    <div className="cardInfo">
                      <h1
          ...
          {[3, 4].map(index => (
            <div className="card4N5" key={index} aria-label={rewards[index].name}>
              <div
                ...
                style={{ backgroundImage: `url(${rewards[index].image})` }}
              ></div>
              <a target="_blank" rel="noreferrer" href="https://jerseyniho.com/product/%d7%9e%d7%99%d7%a1%d7%98%d7%a8%d7%99-%d7%91%d7%95%d7%a7%d7%a1/">
                <div className="cardInfo">
                  <h1
                    className="card-title2"
                    style={{ color: index === 3 ? '#2d3839' : '#585858', textShadow: '-4px 4px 2px rgba(93, 89, 89, 0.7)' }}
                  >
